...
#define probe1_Pin GPIO_PIN_9
#define probe1_GPIO_Port GPIOF
...
#define XBEE_DTR_Pin GPIO_PIN_10
...
#define probe2_Pin GPIO_PIN_1
#define probe2_GPIO_Port GPIOD
